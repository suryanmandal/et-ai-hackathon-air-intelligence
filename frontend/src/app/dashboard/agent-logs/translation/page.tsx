...
const TRANSLATIONS: Record<string, TranslationData> = {
  ...
  bho: {
    title: "आपातकालीन प्रेषण चेतावनी: क्षेत्र MUM_042",
    description: "पूर्वी फ्रीवे के लगे नाइट्रोजन डाइऑक्साइड (NO2) गैस के बहुत ढेर मात्रा मिलल बा। ग्राउंड टेलीमेट्री मॉनिटर बतावत बा कि ई स्तर १८४ μg/m³ के सीमा के पार क गइल बा।",
    actions: "हाइपरलोकल परिधि जांच खातिर सोर्स एट्रिब्यूशन एजेंट के भेजल जात बा। हाइवे के जाम कम करे खातिर ऑटोमेटिक ट्रैफिक डायवर्टर के आग्रह कइल जात बा और नगर निगम के स्क्रीन पर चेतावनी जारी कइल जात बा।",
    compliance: "GovChain ब्लॉकचेन सिंक्रोनाइजेशन पूरा भइल। नियम रूट लेवल पर लागू कइल गइल बा।",
    logTitle: "एजेंट गतिविधि स्ट्रीम — लाइव"
  },
  mai: {
    title: "आपातकालीन प्रेषण चेतावनी: क्षेत्र MUM_042",
    description: "पूर्वी फ्रीवे क समीप नाइट्रोजन डाइऑक्साइड (NO2) गैसक पैघ सांद्रता भेटल अछि। ग्राउंड टेलीमेट्री मॉनिटरक अनुसार स्तर १८४ μg/m³ क सीमा पार क गेल अछि।",
    actions: "हाइपरलोकल परिधि जांचक लेल सोर्स एट्रिब्यूशन एजेंट पठाओल जा रहल अछि। हाइवे जाम कम करबाक लेल ऑटोमेटिक ट्रैफिक डायवर्टरक अनुरोध और नगर निगम स्क्रीन पर सार्वजनिक चेतावनी जारी।",
    compliance: "GovChain ब्लॉकचेन सिंक्रोनाइजेशन पूर्ण भेल। वैधानिक नियम लागू कएल गेल अछि।",
    logTitle: "एजेंट गतिविधि स्ट्रीम — लाइव"
  },
  awa: {
    title: "आपातकालीन प्रेषण चेतावनी: क्षेत्र MUM_042",
    description: "पूर्वी फ्रीवे क लगे नाइट्रोजन डाइऑक्साइड (NO2) गैस क भारी मात्रा पावा गवा है। ग्राउंड टेलीमेट्री मॉनिटर बतावत हैं कि स्तर १८४ μg/m³ क वैधानिक सीमा पार कइ गवा है।",
    actions: "हाइपरलोकल जांच बरे सोर्स एट्रिब्यूशन एजेंट भेजा जात है। हाइवे क जाम कम करे बरे ऑटोमेटिक ट्रैफिक डाइवर्जन क अनुरोध अउर म्युनिसिपल स्क्रीन पर चेतावनी प्रसारित कीन जात है।",
    compliance: "GovChain ब्लॉकचेन सिंक्रोनाइजेशन पूरा होइ गवा। नियम जड़ स्तर पर लागू कीन गवा है।",
    logTitle: "एजेंट गतिविधि स्ट्रीम — लाइव"
  },
  or: {
    title: "ଜରୁରୀକାଳୀନ ଚେତାବନୀ: ସେକ୍ଟର MUM_042",
    description: "ଇଷ୍ଟର୍ଣ୍ଣ ଫ୍ରିୱେ ନିକଟରେ ନାଇଟ୍ରୋଜେନ୍ ଡାଇଅକ୍ସାଇଡ୍ (NO2) ର ଅଧିକ ସାନ୍ଦ୍ରତା ଚିହ୍ନଟ ହୋଇଛି। ଗ୍ରାଉଣ୍ଡ୍ ଟେଲିମେଟ୍ରି ସୂଚାଉଛି ଯେ ଏହା ୧୮୪ ଉପରୋକ୍ତ ସୀମା ଅତିକ୍ରମ କରିଛି।",
    actions: "ଉତ୍ସ ଚିହ୍ନଟକାରୀ ଏଜେଣ୍ଟଙ୍କୁ ପଠାଯାଉଛି। ଟ୍ରାଫିକ୍ ନିୟନ୍ତ୍ରଣ ପାଇଁ ସ୍ୱୟଂଚାଳିତ ଡାଇଭର୍ସନ ଅନୁରୋଧ ଓ ଜନସାଧାରଣଙ୍କୁ ସୂଚନା ପ୍ରସାର।",
    compliance: "GovChain ବ୍ଲକଚେନ୍ ସିଙ୍କ୍ରୋନାଇଜେସନ ସମ୍ପୂର୍ଣ୍ଣ। ନିୟମାବଳୀ ଲାଗು କରାଯାଇଛି।",
    logTitle: "ଏଜେଣ୍ଟ କ୍ରିୟାକଳାପ — ଲାଇଭ୍"
  },
  raj: {
    title: "आपातकालीन चेतावनी: क्षेत्र MUM_042",
    description: "पूर्वी फ्रीवे क कने नाइट्रोजन डाइऑक्साइड (NO2) गैस री घणी मात्रा मिली है। धरातलीय टेलीमेट्री मॉनिटर बतावे है कि स्तर १८४ μg/m³ री सीमा ने पार कर गयो है।",
    actions: "हाइपरलोकल जांच सारु सोर्स एट्रिब्यूशन एजेंट ने भेज्यो जा रह्यो है। जाम कम करण सारु ऑटोमेटिक ट्रैफिक डायवर्जन री अरज और म्युनिसिपल स्क्रीन माथे चेतावनी जारी।",
    compliance: "GovChain ब्लॉकचेन सिंक्रोनाइजेशन पूरो हुयो। नियम जड़ स्तर माथे लागू करिया गया है।",
    logTitle: "एजेंट री गतिविधि — लाइव"
  },
  as: {
    title: "জৰুৰীকালীন সতৰ্কবাণী: ছেক্টৰ MUM_042",
    description: "ইষ্টাৰ্ন ফ্ৰীৱেৰ ওচৰত নাইট্ৰ’জেন ডাই অক্সাইড (NO2) গেছৰ অতিমাত্ৰা ঘনত্ব ধৰা পৰিছে। এই মাত্ৰা ১৮৪ μg/m³ ৰ বিপদসীমা অতিক্ৰম কৰিছে।",
    actions: "উৎস সন্ধানকাৰী এজেণ্ট প্ৰেৰণ কৰা হৈছে। পথৰ যান-জঁট কমাবলৈ স্বয়ংক্ৰিয় ডাইভাৰচনৰ অনুৰোধ আৰু সতৰ্কবাণী প্ৰচাৰ কৰা হৈছে।",
    compliance: "GovChain ব্লকচেইন ছিংক্ৰোনাইজেচন সম্পূৰ্ণ। নিয়মাৱলী প্ৰয়োগ কৰা হৈছে।",
    logTitle: "এজেণ্টৰ কাৰ্যকলাপ — লাইভ"
  },
  mni: {
    title: "অকাইবা চেকশিনৱারোল: সেক্তর MUM_042",
    description: "ইস্তরন ফ্রীৱে মনাকতা নাইত্রোজেন দাইওক্সাইদ (NO2) গ্যাস চাউনা থেংনরে। মসি ১৮৪ μg/m³ লৈঙাক্কী চেকশিন থাগৎলকপা লেন্দুনা চৎনরে।",
    actions: "সোর্স এত্রিব্যুসন এজেন্ত থাদোকখ্রে। গারী চৎপগী মশিং হন্থনবা ওতোমেতিক ত্রাফিক দাইভর্তর শীজিন্নখ্রে অমসুং চেকশিনৱারোল ফোংখ্রে।",
    compliance: "GovChain ব্লোকচেন সিঙ্ক্রোনাইজেসন লোইখ্রে। লৈঙাক্কী কাঙলোনশিং চৎনরে।",
    logTitle: "এজেন্ট এক্টিভিটি — লাইভ"
  },
  gu: {
    ...
    actions: "સ્થાનિક સીમા ઓડિટ માટે સોર્સ એટ્રિબ્યુશન એજન્ટ મોકલવામાં આવી રહ્યો છે. હાઇવે ટ્રાફિક ઘટાડવા ઓટોમેટિક ડાયવર્ઝનની વિનંતી અને જાહેર ચેતવણી પ્રસારણ.",
  ...
  ta: {
    ...
    compliance: "GovChain பிளாக்செயின் ஒத்திசைவு முடிந்தது. சட்டப்பூர்வ காற்றுத் தரம் விதிகள் செயல்படுத்தப்பட்டுள்ளன.",
  ...
  kn: {
    ...
    description: "ಈಸ್ಟರ್ನ್ ಫ್ರೀವೇ ಹತ್ತಿರ ನೈಟ್ರೋಜン ಡೈಆಕ್ಸೈಡ್ (NO2) ಅನಿಲದ ಹೆಚ್ಚಿನ ಸಾಂದ್ರತೆ ಪತ್ತೆಯಾಗಿದೆ. ನೆಲದ ಟೆಲಿಮೆಟ್ರಿ 184 μg/m³ ಕಡ್ಡಾಯ ಅಪಾಯದ ಮಿತಿಯನ್ನು ಮೀರಿದೆ ಎಂದು ತೋರಿಸುತ್ತದೆ.",
    actions: "ಮೂಲ ಅಟ್ರಿಬ್ಯೂಷನ್ ಏಜೆಂಟರನ್ನು ಕಳುಹಿಸಲಾಗುತ್ತಿದೆ. ಹೆದ್ದಾರಿ ದಟ್ಟಣೆ ಕಡಿಮೆ ಮಾಡಲು ಸ್ವಯಂಚಾಲಿತ ಸಂಚಾರ ಡೈವರ್ಟರ್‌ಗಳ ವಿನಂತಿ ಮತ್ತು ಸಾರ್ವಜನಿಕ ಎಚ್ಚರಿಕೆ ಪ್ರಸಾರ.",
  ...
  pa: {
    ...
    actions: "ਸਰੋਤ ਨਿਰਧਾਰਨ ਏਜੰਟ ਭੇਜਿਆ ਜਾ ਰਿਹਾ ਹੈ। ਹਾਈਵੇ ਦੀ ਭੀੜ ਘਟਾਉਣ ਲਈ ਆਟოਮੈਟिक ਟ੍ਰੈਫਿਕ ਡਾਇਵਰਸ਼ਨ ਅਤੇ ਨਗਰ ਨਿਗਮ ਸਕ੍ਰੀਨਾਂ 'ਤੇ ਚੇਤਾਵਨੀਆਂ ਪ੍ਰਸਾਰਿਤ ਕਰਨਾ।",
...
const LANGUAGES = [
  { code: "bho", name: "Bhojpuri (भोजपुरी)", state: "Bihar & UP" },
  { code: "mai", name: "Maithili (मैथिली)", state: "Bihar" },
  { code: "awa", name: "Awadhi (अवधी)", state: "Uttar Pradesh" },
  { code: "or", name: "Odia (ଓଡ଼ିଆ)", state: "Odisha" },
  { code: "raj", name: "Rajasthani (राजस्थानी)", state: "Rajasthan" },
  { code: "as", name: "Assamese (অসমীয়া)", state: "Assam" },
  { code: "mni", name: "Manipuri (মণিপুরী)", state: "Manipur" },
  ...
  { code: "te", name: "Telugu (తెలుగు)", state: "Andhra/Telangana" },
...
export default function LanguageTranslationHub() {
  ...
  useEffect(() => {
    if (activeCorp?.state) {
      ...
      else if (stateName.includes("bihar")) {
        // Bihar auto-selects Bhojpuri (since many civil servants from Bihar use it)
        matchedLang = "bho";
      }
      else if (stateName.includes("uttar pradesh")) {
        // UP auto-selects Awadhi
        matchedLang = "awa";
      }
      else if (stateName.includes("odisha") || stateName.includes("orissa")) matchedLang = "or";
      else if (stateName.includes("rajasthan")) matchedLang = "raj";
      else if (stateName.includes("assam")) matchedLang = "as";
      else if (stateName.includes("manipur")) matchedLang = "mni";
